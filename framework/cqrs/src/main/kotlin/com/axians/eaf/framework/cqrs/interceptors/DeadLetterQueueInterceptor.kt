...
class DeadLetterQueueInterceptor(
    ...
    override fun handle(
        ...
        return try {
            ...
            // Store in DLQ
            captureFailure(unitOfWork.message, ex, OperationType.COMMAND)
    ...
    fun <T> handleEvent(
        ...
        return try {
            ...
            // Store in DLQ
            captureFailure(unitOfWork.message, ex, OperationType.EVENT)
    ...
    fun <T, R> handleQuery(
        ...
        return try {
            ...
            // Store in DLQ
            captureFailure(unitOfWork.message, ex, OperationType.QUERY)
    ...
    private fun <T> captureFailure(
        ...
        try {
            ...
            val traceId = observationRegistry.currentObservation?.context?.traceId
            ...
            logger.error(
                "Captured failed operation in DLQ: type={}, payloadType={}, exception={}, traceId={}",
                operationType,
