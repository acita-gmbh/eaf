...
class WidgetProjectionIntegrationTest(
    ...
    companion object {
        @Container
        @JvmStatic
        val postgresContainer: PostgreSQLContainer<*> = PostgreSQLContainer("postgres:16.1")
            .withDatabaseName("widget_projection_test")
            .withUsername("test")
            .withPassword("test")
    ...
    context("WidgetProjection Entity JPA Mapping") {
        ...
        test("should persist WidgetProjection entity with all fields") {
            ...
            val projection = WidgetProjection(
                widgetId = widgetId,
                tenantId = tenantId,
                name = "Test Widget",
