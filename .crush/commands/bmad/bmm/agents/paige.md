...
This command activates the Documentation Guide agent from the BMAD BMM module.

## File Reference

Complete agent definition: [bmad/bmm/agents/paige.md](bmad/bmm/agents/paige.md)
