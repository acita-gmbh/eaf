...
public class ApplicationConfig {
    ...
    ): VmProvisioningListener = VmProvisioningListener(eventStore, eventDeserializer, provisionVmHandler)

    @Bean
    public fun triggerProvisioningHandler(
        vspherePort: VspherePort,
        configPort: VmwareConfigurationPort
    ): TriggerProvisioningHandler = TriggerProvisioningHandler(vspherePort, configPort)
