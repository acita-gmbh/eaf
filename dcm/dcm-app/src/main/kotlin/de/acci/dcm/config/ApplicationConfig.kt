...
import de.acci.dcm.application.vm.ProvisionVmHandler
import de.acci.dcm.application.vm.ResilientProvisioningService
import de.acci.dcm.application.vm.TriggerProvisioningHandler
import de.acci.dcm.application.vm.VmProvisioningListener
import de.acci.dcm.application.vm.VmEventDeserializer
...
import de.acci.dcm.application.vmrequest.ApproveVmRequestHandler
import de.acci.dcm.application.vmrequest.CancelVmRequestHandler
import de.acci.dcm.application.vmrequest.CreateVmRequestHandler
import de.acci.dcm.application.vmrequest.GetAdminRequestDetailHandler
import de.acci.dcm.application.vmrequest.GetMyRequestsHandler
import de.acci.dcm.application.vmrequest.GetPendingRequestsHandler
import de.acci.dcm.application.vmrequest.GetRequestDetailHandler
import de.acci.dcm.application.vmrequest.MarkVmRequestProvisioningHandler
import de.acci.dcm.application.vmrequest.RejectVmRequestHandler
import de.acci.dcm.application.vmrequest.SyncVmStatusHandler
import de.acci.dcm.application.vmrequest.TimelineEventProjectionUpdater
import de.acci.dcm.application.vmrequest.VmStatusProjectionPort
import de.acci.dcm.application.vmrequest.TimelineEventReadRepository
...
import de.acci.dcm.application.vmrequest.VmRequestProjectionUpdater
import de.acci.dcm.application.vmrequest.VmRequestNotificationSender
import de.acci.dcm.application.vmrequest.VmRequestReadRepository
...
import de.acci.dcm.application.vmware.VmwareConfigurationPort
import de.acci.dcm.application.vmware.HypervisorPort
import de.acci.dcm.infrastructure.eventsourcing.JacksonVmEventDeserializer
import de.acci.dcm.infrastructure.eventsourcing.JacksonVmRequestEventDeserializer
import de.acci.dcm.infrastructure.eventsourcing.PublishingEventStore
import de.acci.dcm.infrastructure.projection.AdminRequestDetailRepositoryAdapter
import de.acci.dcm.infrastructure.projection.TimelineEventProjectionUpdaterAdapter
import de.acci.dcm.infrastructure.projection.TimelineEventReadRepositoryAdapter
import de.acci.dcm.infrastructure.projection.TimelineEventRepository
import de.acci.dcm.infrastructure.projection.VmRequestDetailRepositoryAdapter
import de.acci.dcm.infrastructure.projection.VmRequestProjectionRepository
import de.acci.dcm.infrastructure.projection.VmRequestProjectionUpdaterAdapter
import de.acci.dcm.infrastructure.projection.VmRequestReadRepositoryAdapter
import de.acci.dcm.infrastructure.projection.VmStatusProjectionAdapter
...
/**
 * Spring configuration for DCM application beans.
 *
