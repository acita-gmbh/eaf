 ...
 */
@SpringBootTest(
    classes = [DcmApplication::class, DcmApplicationTest.TestConfig::class, TestNotificationConfiguration::class],
    webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT,
)
@ActiveProfiles("test")
class DcmApplicationTest {
    ...
    fun `application context loads successfully`() {
        ...
        assertNotNull(applicationContext.getBean(DcmApplication::class.java))
    }
}
