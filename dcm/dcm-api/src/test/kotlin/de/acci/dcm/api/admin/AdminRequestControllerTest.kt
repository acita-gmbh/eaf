...
import de.acci.dcm.application.vmrequest.AdminRequestDetail
import de.acci.dcm.application.vmrequest.GetAdminRequestDetailError
import de.acci.dcm.application.vmrequest.GetAdminRequestDetailHandler
import de.acci.dcm.application.vmrequest.GetAdminRequestDetailQuery
import de.acci.dcm.application.vmrequest.GetPendingRequestsError
import de.acci.dcm.application.vmrequest.GetPendingRequestsHandler
import de.acci.dcm.application.vmrequest.GetPendingRequestsQuery
import de.acci.dcm.application.vmrequest.ProjectSummary
import de.acci.dcm.application.vmrequest.RequesterInfo
import de.acci.dcm.application.vmrequest.TimelineEventItem
...
import de.acci.dcm.application.vmrequest.VmSizeInfo
...
class AdminRequestControllerTest {
    ...
    private val approveVmRequestHandler = mockk<de.acci.dcm.application.vmrequest.ApproveVmRequestHandler>()
    private val rejectVmRequestHandler = mockk<de.acci.dcm.application.vmrequest.RejectVmRequestHandler>()
    ...
    inner class ApproveRequestTests {
        ...
        fun `should return 200 OK on successful approval`() = runTest {
            ...
            val approvalResult = de.acci.dcm.application.vmrequest.ApproveVmRequestResult(requestId = requestId)
        ...
        fun `should return 404 for non-existent request`() = runTest {
            ...
            coEvery {
                approveVmRequestHandler.handle(any(), any())
            } returns de.acci.dcm.application.vmrequest.ApproveVmRequestError.NotFound(
                requestId = requestId
            ).failure()
        ...
        fun `should return 404 for self-approval`() = runTest {
            ...
            coEvery {
                approveVmRequestHandler.handle(any(), any())
            } returns de.acci.dcm.application.vmrequest.ApproveVmRequestError.Forbidden().failure()
        ...
        fun `should return 422 for invalid state`() = runTest {
            ...
            coEvery {
                approveVmRequestHandler.handle(any(), any())
            } returns de.acci.dcm.application.vmrequest.ApproveVmRequestError.InvalidState(
        ...
        fun `should return 409 for concurrency conflict`() = runTest {
            ...
            coEvery {
                approveVmRequestHandler.handle(any(), any())
            } returns de.acci.dcm.application.vmrequest.ApproveVmRequestError.ConcurrencyConflict(
        ...
        fun `should return 500 for persistence failure`() = runTest {
            ...
            coEvery {
                approveVmRequestHandler.handle(any(), any())
            } returns de.acci.dcm.application.vmrequest.ApproveVmRequestError.PersistenceFailure(
                message = "Database error"
            ).failure()
    ...
    inner class RejectRequestTests {
        ...
        fun `should return 200 OK on successful rejection`() = runTest {
            ...
            val rejectResult = de.acci.dcm.application.vmrequest.RejectVmRequestResult(requestId = requestId)
        ...
        fun `should return 404 for non-existent request on reject`() = runTest {
            ...
            coEvery {
                rejectVmRequestHandler.handle(any(), any())
            } returns de.acci.dcm.application.vmrequest.RejectVmRequestError.NotFound(
                requestId = requestId
            ).failure()
        ...
        fun `should return 404 for self-rejection`() = runTest {
            ...
            coEvery {
                rejectVmRequestHandler.handle(any(), any())
            } returns de.acci.dcm.application.vmrequest.RejectVmRequestError.Forbidden().failure()
        ...
        fun `should return 422 for invalid state on reject`() = runTest {
            ...
            coEvery {
                rejectVmRequestHandler.handle(any(), any())
            } returns de.acci.dcm.application.vmrequest.RejectVmRequestError.InvalidState(
        ...
        fun `should return 422 for invalid reason`() = runTest {
            ...
            coEvery {
                rejectVmRequestHandler.handle(any(), any())
            } returns de.acci.dcm.application.vmrequest.RejectVmRequestError.InvalidReason(
        ...
        fun `should return 409 for concurrency conflict on reject`() = runTest {
            ...
            coEvery {
                rejectVmRequestHandler.handle(any(), any())
            } returns de.acci.dcm.application.vmrequest.RejectVmRequestError.ConcurrencyConflict(
                message = "Concurrent modification"
            ).failure()
        ...
        fun `should return 500 for persistence failure on reject`() = runTest {
            ...
            coEvery {
                rejectVmRequestHandler.handle(any(), any())
            } returns de.acci.dcm.application.vmrequest.RejectVmRequestError.PersistenceFailure(
                message = "Database error"
            ).failure()
