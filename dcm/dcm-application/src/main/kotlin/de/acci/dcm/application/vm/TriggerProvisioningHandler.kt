...
import de.acci.dcm.application.vmrequest.ProvisioningFailedAdminNotification
import de.acci.dcm.application.vmrequest.ProvisioningFailedUserNotification
...
import de.acci.dcm.application.vmrequest.logNotificationError
...
import de.acci.dcm.domain.vm.VmAggregate
...
public class TriggerProvisioningHandler(
    ...
    /** Base URL for portal links in notifications (AC-3.8.1). Example: "https://dcm.example.com" */
    ...
    private suspend fun emitSuccess(
        ...
        try {
            ...
            throw e  // Allow proper coroutine cancellation
        } catch (e: de.acci.dcm.domain.exceptions.InvalidStateException) {
