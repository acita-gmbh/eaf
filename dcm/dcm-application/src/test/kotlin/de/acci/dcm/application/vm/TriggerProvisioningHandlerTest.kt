...
import de.acci.dcm.application.vmrequest.NewTimelineEvent
import de.acci.dcm.application.vmrequest.NoOpVmRequestNotificationSender
...
import de.acci.dcm.application.vmware.ProvisioningErrorCode
...
import de.acci.dcm.domain.vmrequest.events.VmRequestReady
...
class TriggerProvisioningHandlerTest {
    ...
    private fun createVmRequestProvisioningStartedEvent(
        ...
        tenantId: TenantId,
        userId: UserId
    ): de.acci.dcm.domain.vmrequest.events.VmRequestProvisioningStarted =
        de.acci.dcm.domain.vmrequest.events.VmRequestProvisioningStarted(
    ...
    inner class SuccessNotifications {
        ...
        fun `should send VM ready notification on successful provisioning`() = runTest {
            ...
            val handler = TriggerProvisioningHandler(
                ...
                portalBaseUrl = "https://dcm.example.com"
            )
            ...
            assertEquals("https://dcm.example.com/requests/${event.requestId.value}", notification.portalLink)
        ...
        fun `should continue successfully when notification fails`() = runTest {
            ...
            coEvery { mockNotificationSender.sendVmReadyNotification(any()) } returns de.acci.eaf.core.result.Result.Failure(
                de.acci.dcm.application.vmrequest.VmRequestNotificationError.SendFailure("SMTP server unavailable")
            )
