...
import de.acci.dcm.application.vmware.ConnectionError
import de.acci.dcm.application.vmware.ConnectionInfo
 ...
 * set `dcm.vcenter.ignore-cert=true` (not recommended for production).
 *
 * ## Threading
 *
