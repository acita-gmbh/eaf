...
import de.acci.dcm.domain.vmware.VcenterConnectionParams
    ...
    override suspend fun testConnection(
        ...
        try {
            ...
            if (!params.vcenterUrl.startsWith("https://")) {
                return@withContext de.acci.dcm.application.vmware.ConnectionError.NetworkError(
            ...
            if (params.username.isBlank() || password.isBlank()) {
                return@withContext de.acci.dcm.application.vmware.ConnectionError.AuthenticationFailed(
            ...
            de.acci.dcm.application.vmware.ConnectionInfo(
            ...
            de.acci.dcm.application.vmware.ConnectionError.ApiError(
