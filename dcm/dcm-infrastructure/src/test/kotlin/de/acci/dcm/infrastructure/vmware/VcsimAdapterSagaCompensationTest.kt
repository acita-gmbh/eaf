...
class VcsimAdapterSagaCompensationTest {
    ...
    inner class DeletionTracking {
        ...
        fun `tracks deleted VM IDs for saga compensation verification`() = runTest {
            ...
            // When: Delete the VM
            adapter.deleteVm(de.acci.dcm.application.vmware.VmId(vmId.value))
        ...
        fun `deleted VMs list is cleared on clearSimulatedError`() = runTest {
            ...
            adapter.deleteVm(de.acci.dcm.application.vmware.VmId("vm-001"))
            adapter.deleteVm(de.acci.dcm.application.vmware.VmId("vm-002"))
        ...
        fun `multiple deletions are tracked separately`() = runTest {
            ...
            adapter.deleteVm(de.acci.dcm.application.vmware.VmId("vm-001"))
            adapter.deleteVm(de.acci.dcm.application.vmware.VmId("vm-002"))
            adapter.deleteVm(de.acci.dcm.application.vmware.VmId("vm-003"))
