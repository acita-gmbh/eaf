...
We use a starter kit called **shadcn-admin-kit** which gives us a head start on complex admin layouts.

### Key Components

*   **Card:** The building block of our dashboard. Used for stats, forms, and lists.
