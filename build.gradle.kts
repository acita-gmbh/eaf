...
subprojects {
    // Skip widget-demo entirely from root dependency enforcement
    // Widget-demo needs Netty 4.2.1.Final for Gatling, which is incompatible with global 4.1.125.Final
